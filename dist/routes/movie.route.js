 ...
 * Create a movie.
 */
router.post("/movies", authenticateToken, validateRequestSchema(createMovieSchema), MovieController.createMovie);
/**
 *
 */
router.get("/movies/favorites", authenticateToken, MovieController.getFavoriteMovies);
/**
 *
 */
router.get("/movies/comments", authenticateToken, MovieController.getCommentedMovies);
/**
 *
 */
router.get("/movies/ratings", authenticateToken, MovieController.getRatedMovies);
/**
 * Update a movie.
 */
router.put("/movies/:id", authenticateToken, validateRequestSchema(updateMovieSchema), MovieController.updateMovie);
/**
 * Delete a movie.
 */
 ...
 */
router.get("/movies/:movieId/recommendations", MovieController.recommendationsByMovieId);
/**
 * Get movies by genre.
 */
